---
title: "Secuenciando tu turno"
date: 2026-07-16T18:34:11+02:00
draft: false
language: es
images:
tags:
...
Antes de tomar cualquier decisión, pon tus cartas a un lado y piensa. Nada es obvio y debes considerar todas las opciones posibles. A veces internalizamos jugadas "obvias" que situacionalmente son malas o nos pueden llevar a no tener recursos para jugar otras cartas, como activar ciertos triggers necesarios para mantenerte en la partida.
...
### Secuenciado de turnos para perritos, Set 11

#### Ready

#### Set
1. **¿Puedo jugar Lilo desde el descarte?**: ¿Cómo afecta eso a mi economía de tintas? ¿Previene de alguna manera la posibilidad de jugar doble Tramp7? ¿Habilita el "Cheshire Cat" del oponente? ¿Puedo utilizarlo para forzar tradeos a mi favor?

#### Draw
1. ¿En qué fase me encuentro actualmente? Estableciendo cantantes de 8, Cantantes de 8 establecidos, pelea midrange, clock...
2. ¿Debería de jugar alrededor de alguna carta? Demona, Elsa...
3. ¿Tengo la posibilidad de jugar Lady5? Revisar el descarte para ver cartas que puedan cambiar mi turno.
...
#### Resto del turno a mitad de partida

1. Antes de lorear ¿qué cartas pueden afectar mis cantantes de 8 en mesa el siguiente turno? ¿cuantas amenazas pueden eliminarme? ¿cuál es el peor de los casos? Si seguimos en el plan de UTS ¿cómo afecta esto a nuestra capacidad de hacer el combo?
2. Contar Fuerza vs Vitalidad de las cartas de tu oponente.

#### Plan de inicio de partida
1. Planear subconjuntos de cartas que podemos jugar en cada turno con la mano actual.
2. Plan de tintado.
3. Plan de cantantes de 8 ¿Cuál es la mejor manera de plantar cantantes de 8 en mesa antes de jugar Tramp7?
4. Si hemos jugado Willow en turno 2 ¿podemos jugar Tramp7 para llenar el descarte en este matchup?
5. Hemos jugado Tramp7 ¿cambia esto nuestro plan anterior de jugar Lady5?

#### Clock en el final de partida

1. ¿Tengo yo el clock? ¿lo tiene mi oponente? ¿de cuantos turnos es el clock?
2. Si me plantean un clock ¿puedo plantear yo uno más rápido?
3. ¿Es mi único plan de partida cantar UTS? Si es así, quizás no renta lorear.
4. Cuenta Fuerza vs Vitalidad de las cartas de tu oponente.
5. Perder 20-0 es lo mismo que perder 20-19.

## Conclusiones
Creo que se entiende. La idea es tener unos turnos más estructurados, hacernos las preguntas correctas y después tomar decisiones. No es nada nuevo. Puedes ir actualizando el plan de partida según vayas conociendo mejor el juego o tu mazo. Intentaré ir actualizando este artículo con nuevas cosillas que vaya integrando en mi plan de partida.

Gracias por leer el artículo, espero que te haya gustado.
